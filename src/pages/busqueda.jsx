...
const MainPelis = () => {
  ...
  const [showMovieDetails, setShowMovieDetails] = useState(false); // Estado para controlar la visibilidad del div de detalles
  ...
  const selectMovie = async (selectedMovie) => {
    ...
    setShowMovieDetails(true); // Mostrar el div de detalles al seleccionar una película
    window.scrollTo(0, 0);
  };
  ...
  return (
    <main className="bg-blue-900/55 min-h-screen">
      <div className="container mx-auto py-8">
        ...
        {showMovieDetails && ( // Mostrar el div de detalles solo si showMovieDetails es verdadero
